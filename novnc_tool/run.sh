...
# VNC Lab - novnc_tool Run Script
# Run Docker container for enhanced tools VNC environment
...
show_usage() {
    ...
    echo "  $0 -p 9000 -T 9001      # Use custom ports"
...
DOCKER_RUN_CMD="$DOCKER_RUN_CMD -p 127.0.0.1:$VNC_PORT:8080"
