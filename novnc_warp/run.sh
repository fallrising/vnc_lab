...
# VNC Lab - novnc_warp Run Script
# Run Docker container for Warp terminal VNC environment
...
if eval $DOCKER_RUN_CMD; then
    ...
    print_status "Access your Warp terminal:"
    ...
    print_status ""
    print_status "Warp AI features:"
    print_status "  - AI commands: Cmd+K to open AI command palette"
    print_status "  - AI chat: Cmd+L to open AI chat"
    print_status "  - Command history: Use AI to find and reuse commands"
else
