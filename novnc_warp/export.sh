...
# VNC Lab - novnc_warp Export Script
# Export Docker images and configurations for Warp terminal VNC environment
...
DEFAULT_EXPORT_NAME="novnc_warp_export"
...
{
    echo "VNC Lab - novnc_warp Export Summary"
    echo "==================================="
